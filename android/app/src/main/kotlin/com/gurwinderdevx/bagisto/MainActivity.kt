package com.gurwinderdevx.bagisto
...
import com.gurwinderdevx.bagisto.arcore.activities.ArActivity

class MainActivity : FlutterFragmentActivity() {
    private val EVENTS = "com.gurwinderdevx.bagisto/channel"
            ...
            try {
                ...
                if (call.method == "initialLink") {
                    ...
                    val photoURI: Uri = FileProvider.getUriForFile(
                        ...
                        "com.gurwinderdevx.bagisto.provider",
                        file
                    )
