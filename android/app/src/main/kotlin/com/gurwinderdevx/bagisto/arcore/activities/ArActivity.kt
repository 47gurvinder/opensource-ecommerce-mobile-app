...
package com.gurwinderdevx.bagisto.arcore.activities
...
import com.gurwinderdevx.bagisto.databinding.ActivityArBinding
                ...
                ModelRenderable.builder()
                    ...
                    .exceptionally { throwable: Throwable? ->
                     //   Log.i("Model", "cant load")
                        ...
                        mModelStateSnackBar = Snackbar.make(mContentViewBinding.arLayout, getString(
                            R.string.model_error), Snackbar.LENGTH_INDEFINITE).setAction(getString(R.string.try_again)) {
                            mModelStateSnackBar?.dismiss()
                        }
                        null
                    }
